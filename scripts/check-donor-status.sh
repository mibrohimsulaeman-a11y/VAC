...
check_contracts() { [[ -f vac-rs/crates/control-plane/control-plane/src/control_plane/donor_domain_contract.rs ]] || fail "missing donor contract source"; for plan in 01 02 03 04 05 06 07 08 09 10 11; do grep -Eq "plan_id: \"?$plan\"?" vac-rs/crates/control-plane/control-plane/src/control_plane/donor_domain_contract.rs || fail "domain contract missing plan_id $plan"; done; ok "static donor domain contract registry covers plans 01-11"; }
