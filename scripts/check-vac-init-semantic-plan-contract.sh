...
SRC="vac-rs/control-plane/src/control_plane/vac_init_semantic_plan.rs"
require_file "$SRC"
...
require_grep 'pub mod vac_init_semantic_plan;' vac-rs/control-plane/src/control_plane/mod.rs
