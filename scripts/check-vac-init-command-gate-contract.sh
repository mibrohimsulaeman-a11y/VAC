...
SRC="vac-rs/control-plane/src/control_plane/vac_init_command_gate.rs"
require_file "$SRC"
...
require_grep 'pub mod vac_init_command_gate;' vac-rs/control-plane/src/control_plane/mod.rs
