...
grep -q 'build_vac_init_live_scanner_reports' vac-rs/cli/src/init_cli.rs
grep -q '.vac/.init/source_inventory.yaml' vac-rs/cli/src/init_cli.rs
grep -q '.vac/.init/risk_findings.yaml' vac-rs/cli/src/init_cli.rs
grep -q '.vac/.init/policy_inference_report.yaml' vac-rs/cli/src/init_cli.rs
