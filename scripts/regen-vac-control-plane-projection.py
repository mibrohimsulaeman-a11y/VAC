#!/usr/bin/env python3
"""Regenerate source-derived .vac/.init and docs-state projection.

Regenerates only derivable material and preserves append-only evidence/plans/
trajectory. Legacy generated docs are intentionally pruned and must not be
...
def write_docs_projection():
    ...
    docs_state = [
        ...
        "docs:", f"  markdown_files: {len(docs)}", "  index: docs/workflow-control-plane/INDEX.md", "  state: docs/workflow-control-plane/IMPLEMENTATION_PLAN.md", "  audit: .vac/registry/capability-readiness-audit.md", "  by_top_level:",
    ]
    ...
    docs_state.extend([
        ...
        "donor:", "  docs_pruned: true", "  inventory: .vac/registry/donor-inventory.yaml", "  living_docs_path_absent: docs/donor-migration", "  reason: Legacy generated docs were pruned; active docs are limited to workflow-control-plane and legal notice indexes.",
