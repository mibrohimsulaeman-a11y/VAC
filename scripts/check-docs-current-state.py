...
BANNED_PATTERNS = [
    ...
    (re.compile(r"github\.com/Vastar-AI/vac(?:\.git)?", re.I), "obsolete canonical repository coordinate"),
    (re.compile(r"\bVastar-AI/vac\b", re.I), "obsolete canonical repository coordinate"),
    (re.compile(r"ghcr\.io/vastar-ai/vac", re.I), "obsolete container image namespace"),
