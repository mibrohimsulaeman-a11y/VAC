...
require_file vac-rs/control-plane/src/control_plane/vac_init_scanner_policy_hardening.rs
require_file scripts/check-vac-init-scanner-policy-hardening-contract.sh
require_file docs/vac-init/VAC_INIT_PRODUCTION_HARDENING_E_SCANNER_POLICY.md
require_file docs/validation/PRODUCTION_HARDENING_E1_E3_VALIDATION.md
...
"$RUSTC_BIN" --edition 2024 --test vac-rs/control-plane/src/control_plane/vac_init_scanner_policy_hardening.rs -o "$TMPROOT/vac_init_scanner_policy_hardening_test"
