...
This file is a curated helper. Every recommendation here must be verified against current Vastar docs before it is repeated to a user.
...
| `gpt-5.3-vac` | Agentic coding, code editing, and tool-heavy coding workflows |
| `gpt-5.1-vac-mini` | Cheaper coding workflows |
...
- This file will drift unless it is periodically re-verified against current Vastar docs.
