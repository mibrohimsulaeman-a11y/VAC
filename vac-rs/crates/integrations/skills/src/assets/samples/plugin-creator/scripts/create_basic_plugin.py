...
def build_plugin_json(plugin_name: str) -> dict:
    return {
        ...
        "interface": {
            ...
            "developerName": "[TODO: Vastar]",
            "category": "[TODO: Productivity]",
            "capabilities": ["[TODO: Interactive]", "[TODO: Write]"],
            "websiteURL": "[TODO: https://vastar.com/]",
            "privacyPolicyURL": "[TODO: https://vastar.com/policies/row-privacy-policy/]",
            "termsOfServiceURL": "[TODO: https://vastar.com/policies/row-terms-of-use/]",
            "defaultPrompt": [
...
def main() -> None:
    ...
    plugin_json_path = plugin_root / ".vac-plugin" / "plugin.json"
