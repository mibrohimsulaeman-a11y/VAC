...
```json
{
  ...
  "interface": {
    ...
    "developerName": "Vastar",
    "category": "Productivity",
    "capabilities": ["Interactive", "Write"],
    "websiteURL": "https://vastar.com/",
    "privacyPolicyURL": "https://vastar.com/policies/row-privacy-policy/",
    "termsOfServiceURL": "https://vastar.com/policies/row-terms-of-use/",
    "defaultPrompt": [
...
- This repo’s scaffold writes `.vac-plugin/plugin.json`; treat that as the manifest location this skill generates.
...
- `plugins` (`array`): Ordered plugin entries. This order determines how VAC renders plugins.
