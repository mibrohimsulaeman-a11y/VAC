pub(crate) const OTEL_TARGET_PREFIX: &str = "vac_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "vac_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "vac_otel.trace_safe";
