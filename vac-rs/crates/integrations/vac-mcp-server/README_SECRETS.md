...
- **Location**: `.vac/session/secrets.json`
...
**Session file (`.vac/session/secrets.json`):**
...
1. **Session file protection**: Ensure `.vac/session/secrets.json` has appropriate permissions
