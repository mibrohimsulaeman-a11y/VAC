...
*This file is maintained by VAC. Run `vac init` to refresh.*
```
...
- **Set Up VAC Autopilot** -- "I can configure `vac autopilot` to continuously monitor your infrastructure for issues, drift, and security concerns. Want me to set that up?"
