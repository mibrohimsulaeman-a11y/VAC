...
use vac_foundation::define_hook;
use vac_foundation::hooks::{Hook, HookAction, HookContext, HookError, LifecycleEvent};
use vac_foundation::models::integrations::openai::Role;
use vac_foundation::models::llm::{LLMInput, LLMMessage, LLMMessageContent};

const SYSTEM_PROMPT: &str = include_str!("./system_prompt.txt");
const SCRATCHPAD_FILE: &str = ".vac/session/scratchpad.md";
const TODO_FILE: &str = ".vac/session/todo.md";
