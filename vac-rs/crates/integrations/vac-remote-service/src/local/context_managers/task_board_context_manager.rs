...
mod tests {
    ...
    use vac_foundation::models::llm::{LLMMessageContent, LLMMessageTypedContent};
    ...
    /// Run with `cargo test -p vac-remote-service test_verbose_session_simulation -- --nocapture`
    #[test]
    fn test_verbose_session_simulation() {
        ...
        for turn in 0..30 {
            ...
            messages.push(ChatMessage {
                ...
                tool_calls: Some(vec![
                    vac_foundation::models::integrations::openai::ToolCall {
                        id: format!("tc_{}", turn),
                        r#type: "function".to_string(),
