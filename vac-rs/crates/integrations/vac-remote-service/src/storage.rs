...
pub use crate::vac::storage::VACStorage;
...
/// VAC API and local SQLite storage backends.
#[async_trait]
...
impl BackendInfo {
    pub fn vac_remote_service(profile: Option<String>, endpoint: impl Into<String>) -> Self {
        Self {
            kind: BackendKind::VACApi,
            profile,
