...
<file_backups>
    <file
        ...
        backup_path=".vac/session/backups/525963a3.../app.py"
        location="local"
    />
</file_backups>
```
...
- `label: Restore src/app.py from .vac/session/backups/525963a3.../app.py`
...
```
About to run:
  1. Restore src/app.py from .vac/session/backups/525963a3.../app.py
