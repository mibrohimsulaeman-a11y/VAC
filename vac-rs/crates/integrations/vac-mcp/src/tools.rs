...
pub(crate) const MCP_TOOLS_CACHE_WRITE_DURATION_METRIC: &str =
    "vac.mcp.tools.cache_write.duration_ms";
...
pub fn declared_vastar_file_input_param_names(
    ...
    meta.get(META_VASTAR_FILE_PARAMS)
...
pub(crate) fn tool_with_model_visible_input_schema(tool: &Tool) -> Tool {
    let file_params = declared_vastar_file_input_param_names(tool.meta.as_deref());
...
const META_VASTAR_FILE_PARAMS: &str = "vastar/fileParams";
