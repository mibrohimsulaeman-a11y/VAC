...
//!
//! RMCP clients call into this module when a server asks VAC to elicit data
//! from the user. It decides whether the request can be automatically accepted,
//! must be declined by policy, or should be surfaced as a VAC protocol event
...
use vac_protocol::approvals::ElicitationRequest;
...
use vac_rmcp_client::SendElicitation;
