...
pub const ROOT_SEED_CAPABILITY_REQUIREMENTS: &[RootSeedCapabilityRequirement] = &[
    RootSeedCapabilityRequirement {
        ...
        expected_validation: &["cargo +1.95.0 check -p vac-surface-tui --tests"],
    ...
    RootSeedCapabilityRequirement {
        ...
        expected_validation: &["cargo +1.95.0 check -p vac-core"],
    ...
    RootSeedCapabilityRequirement {
        ...
        expected_surfaces: &["surface.tui", "surface.slash", "surface.palette"],
        expected_policy: &["vac.policy.approval", "vac.policy.tools"],
        expected_validation: &["cargo +1.95.0 check -p vac-surface-cli"],
        expected_ownership: &[
    ...
    RootSeedCapabilityRequirement {
        ...
        expected_validation: &[
            "vac doctor build .",
            "cargo +1.95.0 check --manifest-path vac-rs/Cargo.toml -p vac-surface-cli",
        ],
        expected_ownership: &[
    ...
    RootSeedCapabilityRequirement {
        ...
        expected_policy: &["vac.default-local"],
        expected_validation: &[
            "cargo +1.95.0 test -p vac-core architecture_invariants -- --nocapture",
