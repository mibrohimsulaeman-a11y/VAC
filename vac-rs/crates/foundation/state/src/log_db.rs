...
//!
//! # async fn example(state_db: std::sync::Arc<vac_state::StateRuntime>) {
...
mod tests {
    ...
    fn temp_vac_home() -> std::path::PathBuf {
        std::env::temp_dir().join(format!("vac-state-log-db-{}", Uuid::new_v4()))
    }
