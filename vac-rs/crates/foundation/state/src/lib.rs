...
//! orchestration and rollout scanning live in `vac-core`.
...
pub const SQLITE_HOME_ENV: &str = "VAC_SQLITE_HOME";
...
pub const DB_ERROR_METRIC: &str = "vac.db.error";
/// Metrics on backfill process. Tags: [status]
pub const DB_METRIC_BACKFILL: &str = "vac.db.backfill";
/// Metrics on backfill duration. Tags: [status]
pub const DB_METRIC_BACKFILL_DURATION_MS: &str = "vac.db.backfill.duration_ms";
