//! Rollout persistence and discovery for VAC session files.
...
pub(crate) mod default_client {
    pub use vac_login::default_client::*;
}

pub(crate) use vac_protocol::protocol;
...
pub use vac_protocol::protocol::SessionMeta;
