...
/// Process/session ID returned by VAC's terminal runtime.
...
/// Canonical reduced graph for one VAC rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the VAC rollout/session being observed. `trace_id`
    ...
    pub vac_turns: BTreeMap<VACTurnId, VACTurn>,
