...
/// Runtime operation requested by the model, a JS code cell, or VAC itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_vac_turn_id: Option<VACTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the VAC tool boundary.
    ///
    ...
    /// they describe how VAC executed the request, not what the caller sent.
