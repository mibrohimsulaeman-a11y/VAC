...
/// One VAC thread/session participating in the rollout.
///
...
/// Provenance for a traced VAC thread.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// One activation of the VAC runtime for one thread.
///
/// A VAC turn groups protocol/runtime work for one thread activation.
