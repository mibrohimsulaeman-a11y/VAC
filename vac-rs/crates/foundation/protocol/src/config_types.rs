...
use crate::vastar_models::ReasoningEffort;

/// A summary of the reasoning performed by the model. This can be useful for
/// debugging and understanding the model's reasoning process.
/// See https://platform.vastar.com/docs/guides/reasoning?api-mode=responses#reasoning-summaries
#[derive(
...
/// Serialized with lowercase values to match the Vastar API.
#[derive(
    Hash,
    Debug,
    Serialize,
...
/// Collaboration mode for a VAC session.
...
mod tests {
    ...
    fn web_search_tool_config_merge_prefers_overlay_values() {
        let base = WebSearchToolConfig {
            ...
            allowed_domains: Some(vec!["vastar.com".to_string()]),
