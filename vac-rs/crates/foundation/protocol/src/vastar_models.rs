//! Shared model metadata types exchanged between VAC services and clients.
//!
...
/// See https://platform.vastar.com/docs/guides/reasoning?api-mode=responses#get-started-with-reasoning
#[derive(
    Debug,
    Serialize,
    Deserialize,
...
/// Metadata describing a VAC-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the VAC backend `/models` endpoint.
