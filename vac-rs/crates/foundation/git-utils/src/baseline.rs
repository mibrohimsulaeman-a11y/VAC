...
const BASELINE_COMMIT_MESSAGE: &str =
    "Initialize VAC git baseline\n\nCo-authored-by: VAC <noreply@vastar.com>";
...
fn vac_signature() -> gix::actor::Signature {
    gix::actor::Signature {
        name: "VAC".into(),
        email: "noreply@vastar.com".into(),
        time: gix::date::Time {
