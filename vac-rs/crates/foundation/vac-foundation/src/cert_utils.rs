...
impl CertificateChain {
    pub fn generate() -> Result<Self> {
        ...
        ca_params
            .distinguished_name
            .push(DnType::CommonName, "VAC MCP CA");
        ca_params
            .distinguished_name
            .push(DnType::OrganizationName, "VAC");
        ...
        server_params
            .distinguished_name
            .push(DnType::CommonName, "VAC MCP Server");
        server_params
            .distinguished_name
            .push(DnType::OrganizationName, "VAC");
        server_params
        ...
        client_params
            .distinguished_name
            .push(DnType::CommonName, "VAC MCP Client");
        client_params
            .distinguished_name
            .push(DnType::OrganizationName, "VAC");
        client_params
...
impl MtlsIdentity {
    ...
    pub fn generate_client() -> Result<Self> {
        Self::generate_leaf("VAC MCP Client", vec![])
    }
