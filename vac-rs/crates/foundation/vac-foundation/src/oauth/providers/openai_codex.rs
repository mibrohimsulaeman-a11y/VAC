...
impl OpenAICodexProvider {
    ...
    const CLIENT_ID_OVERRIDE_ENV: &'static str = "VAC_OPENAI_OAUTH_CLIENT_ID";
...
mod tests {
    ...
    fn test_oauth_config_for_codex() {
        ...
        unsafe {
            std::env::remove_var("VAC_OPENAI_OAUTH_CLIENT_ID");
        }
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("originator".to_string(), "vac".to_string()),
            ]
        );
        assert_eq!(
    ...
    fn test_oauth_config_uses_env_override_for_client_id() {
        ...
        let provider = OpenAICodexProvider::new();
        unsafe {
            std::env::set_var("VAC_OPENAI_OAUTH_CLIENT_ID", "app_override_test");
        }
