...
use thiserror::Error;
pub use vac_provider_core::providers::openai::runtime::{
    CodexBackendProfile, CompatibleBackendProfile, OfficialBackendProfile, OpenAIBackendProfile,
};
use vac_provider_core::types::{
    CompletionsConfig, OpenAIApiConfig, OpenAIOptions, ResponsesConfig,
};
...
impl OpenAIResolvedConfig {
    pub fn to_provider_core_config(&self) -> vac_provider_core::providers::openai::OpenAIConfig {
        let mut config = vac_provider_core::providers::openai::OpenAIConfig::new(
...
mod tests {
    ...
    #[test]
    fn test_to_provider_core_config_for_codex_oauth() {
        ...
        let config = resolved.to_provider_core_config();
