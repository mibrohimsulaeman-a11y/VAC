...
use vac_protocol::protocol::ThreadMemoryMode as MemoryMode;
...
pub struct CreateThreadParams {
    /// Thread id generated by VAC before opening persistence.
    pub thread_id: ThreadId,
    /// Source thread id when this thread is created as a branch.
    pub branched_from_id: Option<ThreadId>,
...
/// Parameters for loading persisted history for resume, branch, rollback, and memory jobs.
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
...
pub struct StoredThread {
    ...
    pub rollout_path: Option<PathBuf>,
    /// Source thread id when this thread was branched from another thread.
    pub branched_from_id: Option<ThreadId>,
