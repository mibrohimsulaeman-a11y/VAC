# vac-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and VAC did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust VAC on it. Feel free to update the documentation as you
modify the code
...
```rust
use vac_utils_stream_parser::CitationStreamParser;
use vac_utils_stream_parser::StreamTextParser;
...
```rust
use vac_utils_stream_parser::CitationStreamParser;
use vac_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), vac_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use vac_utils_stream_parser::InlineHiddenTagParser;
use vac_utils_stream_parser::InlineTagSpec;
use vac_utils_stream_parser::StreamTextParser;
