//! Helpers for truncating tool and exec output using [`TruncationPolicy`](vac_protocol::protocol::TruncationPolicy).

use vac_protocol::models::FunctionCallOutputContentItem;
pub use vac_utils_string::approx_bytes_for_tokens;
pub use vac_utils_string::approx_token_count;
pub use vac_utils_string::approx_tokens_from_byte_count;
use vac_utils_string::truncate_middle_chars;
use vac_utils_string::truncate_middle_with_token_budget;

pub use vac_protocol::protocol::TruncationPolicy;
