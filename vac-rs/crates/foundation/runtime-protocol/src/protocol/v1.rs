...
pub use vac_protocol::protocol::GitSha;
...
pub struct InitializeResponse {
    ...
    /// Absolute path to the server's $VAC_HOME directory.
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [vac_protocol::protocol::PatchApplyBeginEvent]
    /// and [vac_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [vac_protocol::protocol::ExecCommandBeginEvent]
    /// and [vac_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
...
pub struct GetAuthStatusResponse {
    ...
    pub requires_vastar_auth: Option<bool>,
}
