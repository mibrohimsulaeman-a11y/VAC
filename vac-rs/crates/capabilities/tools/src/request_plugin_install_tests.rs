...
fn build_request_plugin_install_elicitation_request_uses_expected_shape() {
    ...
    let connector = DiscoverableTool::Connector(Box::new(AppInfo {
        ...
        labels: None,
        install_url: Some(
            "https://provider.vac.invalid/apps/google-calendar/connector_2128aebfecb84f64a069897515042a44"
                .to_string(),
        ),
        is_accessible: false,
        is_enabled: true,
    ...
    assert_eq!(
        ...
        McpServerElicitationRequestParams {
            ...
            server_name: "vac-apps".to_string(),
            request: McpServerElicitationRequest::Form {
                meta: Some(json!(RequestPluginInstallMeta {
                    vac_approval_kind: REQUEST_PLUGIN_INSTALL_APPROVAL_KIND_VALUE,
...
fn build_request_plugin_install_elicitation_request_for_plugin_omits_install_url() {
    let args = RequestPluginInstallArgs {
        ...
        action_type: DiscoverableToolAction::Install,
        tool_id: "sample@vastar-curated".to_string(),
...
fn build_request_plugin_install_meta_uses_expected_shape() {
    let meta = build_request_plugin_install_meta(
        ...
        "Gmail",
        Some("https://provider.vac.invalid/apps/gmail/connector_68df038e0ba48191908c8434991bbac2"),
    );
    ...
    assert_eq!(
        ...
        RequestPluginInstallMeta {
            ...
            tool_name: "Gmail",
            install_url: Some(
                "https://provider.vac.invalid/apps/gmail/connector_68df038e0ba48191908c8434991bbac2"
            ),
        },
    );
}
