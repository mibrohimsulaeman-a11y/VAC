...
- recursive grep: ["powershell.exe", "-Command", "Get-ChildItem -Path C:\\myrepo -Recurse | Select-String -Pattern 'VAC-DEBT(owner=vac-o5o6-zero-residual,target=post-cargo-hardening)' -CaseSensitive"]
...
- recursive grep: "Get-ChildItem -Path C:\\myrepo -Recurse | Select-String -Pattern 'VAC-DEBT(owner=vac-o5o6-zero-residual,target=post-cargo-hardening)' -CaseSensitive"
