...
fn create_request_plugin_install_tool_uses_plugin_summary_fallback() {
    let expected_description = concat!(
        ...
        "- Slack (id: `slack@vastar-curated`, type: connector, action: install): No description provided.\n\n",
        "Workflow:\n\n",
...
#[test]
fn filter_request_plugin_install_discoverable_tools_for_vac_tui_omits_plugins() {
