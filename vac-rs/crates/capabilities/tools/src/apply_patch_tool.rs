...
/// VAC-DEBT(owner=vac-o5o6-zero-residual,target=post-cargo-hardening)(dylan): deprecate once we get rid of json tool
...
/// https://platform.vastar.com/docs/guides/function-calling#custom-tools
