...
impl ContextualUserFragment for EnvironmentContext {
    ...
    const START_MARKER: &'static str = vac_protocol::protocol::ENVIRONMENT_CONTEXT_OPEN_TAG;
    const END_MARKER: &'static str = vac_protocol::protocol::ENVIRONMENT_CONTEXT_CLOSE_TAG;
    ...
    fn body(&self) -> String {
        ...
        match &self.network {
            ...
            None => {
                // VAC-DEBT(owner=vac-o5o6-zero-residual,target=post-cargo-hardening)(mbolin): Include this line if it helps the model.
