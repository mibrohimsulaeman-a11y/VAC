...
use vac_protocol::items::ReasoningItem;
...
use vac_protocol::models::is_image_close_tag_text;
use vac_protocol::models::is_image_open_tag_text;
...
pub fn parse_turn_item(item: &ResponseItem) -> Option<TurnItem> {
    match item {
        ...
        ResponseItem::ImageGenerationCall {
            ...
            vac_protocol::items::ImageGenerationItem {
                id: id.clone(),
                status: status.clone(),
