...
use vac_utils_cache::BlockingLruCache;
use vac_utils_cache::sha1_digest;
...
use vac_utils_output_truncation::approx_tokens_from_byte_count_i64;
...
// See https://platform.vastar.com/docs/guides/images-vision#calculating-costs.
...
// See https://platform.vastar.com/docs/guides/images-vision#model-sizing-behavior.
...
pub(crate) fn is_vac_generated_item(item: &ResponseItem) -> bool {
    matches!(
        item,
        ResponseItem::FunctionCallOutput { .. }
            | ResponseItem::ToolSearchOutput { .. }
