...
use vac_api::OpenAiVerbosity;
use vac_api::ResponsesApiRequest;
use vac_api::TextControls;
use vac_api::create_text_param_for_request;
...
fn serializes_text_schema_with_strict_format() {
    ...
    assert_eq!(
        format.get("name"),
        Some(&serde_json::Value::String("vac_output_schema".into()))
    );
    assert_eq!(
        format.get("type"),
