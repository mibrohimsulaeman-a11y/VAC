...
pub(super) async fn spawn_review_thread(
    ...
    let review_turn_context = TurnContext {
        ...
        vac_self_exe: parent_turn_context.vac_self_exe.clone(),
        vac_linux_sandbox_exe: parent_turn_context.vac_linux_sandbox_exe.clone(),
    ...
    // VAC-DEBT(owner=vac-o5o6-zero-residual,target=post-cargo-hardening)(ccunningham): Review turns currently rely on `spawn_task` for TurnComplete but do not
