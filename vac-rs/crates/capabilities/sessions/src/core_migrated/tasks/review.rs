...
use crate::vac_delegate::run_vac_thread_one_shot;
...
impl SessionTask for ReviewTask {
    ...
    async fn run(
        ...
        session
            ...
            .services
            .session_telemetry
            .counter("vac.task.review", /*inc*/ 1, &[]);

        // Start sub-vac conversation and get the receiver for events.
