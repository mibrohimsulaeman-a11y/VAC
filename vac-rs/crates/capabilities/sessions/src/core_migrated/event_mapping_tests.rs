...
use vac_protocol::items::HookPromptFragment;
use vac_protocol::items::TurnItem;
use vac_protocol::items::WebSearchItem;
use vac_protocol::items::build_hook_prompt_message;
...
fn skips_local_image_label_text() {
    ...
    let label = vac_protocol::models::local_image_open_tag_text(/*label_number*/ 1);
...
fn skips_unnamed_image_label_text() {
    let image_url = "data:image/png;base64,abc".to_string();
    let label = vac_protocol::models::image_open_tag_text();
    let user_text = "Please review this image.".to_string();
    ...
    let item = ResponseItem::Message {
        ...
        content: vec![
            ...
            ContentItem::InputText {
                text: vac_protocol::models::image_close_tag_text(),
            },
            ContentItem::InputText {
                text: user_text.clone(),
            },
