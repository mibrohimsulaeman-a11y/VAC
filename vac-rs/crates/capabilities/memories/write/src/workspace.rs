use anyhow::Context;
use std::path::Path;
use vac_git_utils::GitBaselineDiff;
use vac_git_utils::diff_since_latest_init;
use vac_git_utils::ensure_git_baseline_repository;
...
fn render_workspace_diff_file(diff: &GitBaselineDiff) -> String {
    let mut rendered = String::from(
        "# Memory Workspace Diff\n\n\
         Generated by VAC before Phase 2 memory consolidation. Read this file first and do not edit it.\n\n\
         ## Status\n",
    );
