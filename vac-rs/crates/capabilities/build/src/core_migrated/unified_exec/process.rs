...
use vac_exec_server::ReadResponse as ExecReadResponse;
use vac_exec_server::StartedExecProcess;
use vac_exec_server::WriteStatus;
use vac_protocol::exec_output::ExecToolCallOutput;
use vac_protocol::exec_output::StreamOutput;
use vac_protocol::protocol::TruncationPolicy;
...
impl UnifiedExecProcess {
    ...
    pub(super) async fn from_spawned(
        ...
        let output_rx = vac_utils_pty::combine_output_receivers(stdout_rx, stderr_rx);
