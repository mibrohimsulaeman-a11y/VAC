...
pub fn assess_patch_safety(
    ...
    match policy {
        ...
        // VAC-DEBT(owner=vac-o5o6-zero-residual,target=post-cargo-hardening)(ragona): I'm not sure this is actually correct? I believe in this case
