...
const GUARDIAN_PREFERRED_MODEL: &str = "vac-auto-review";
...
pub(crate) struct GuardianAssessment {
    pub(crate) risk_level: vac_protocol::protocol::GuardianRiskLevel,
    pub(crate) user_authorization: vac_protocol::protocol::GuardianUserAuthorization,
