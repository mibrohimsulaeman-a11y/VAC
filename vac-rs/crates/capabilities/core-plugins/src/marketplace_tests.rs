  ...
  "plugins": [
    ...
    assert_eq!(
        ...
        ResolvedMarketplacePlugin {
            plugin_id: PluginId::new("local-plugin".to_string(), "vac-curated".to_string())
                .unwrap(),
...
fn find_marketplace_plugin_supports_git_subdir_sources() {
  ...
  "plugins": [
    ...
    assert_eq!(
        resolved,
        ResolvedMarketplacePlugin {
            plugin_id: PluginId::new("remote-plugin".to_string(), "vac-curated".to_string())
                .unwrap(),
            source: MarketplacePluginSource::Git {
                url: "https://github.com/vastar/joey_marketplace3.git".to_string(),
  ...
  "plugins": [
    ...
    assert_eq!(
        ...
        MarketplacePluginSource::Git {
            url: "https://github.com/vastar/toolkit.git".to_string(),
            path: Some("plugins/toolkit".to_string()),
            ref_name: None,
            sha: None,
        }
  ...
  "plugins": [
    {{
      ...
      "source": {{
        ...
        assert_eq!(
            err.to_string(),
            "plugin `remote-plugin` was not found in marketplace `vac-curated`"
        );
    }
}
...
fn find_marketplace_plugin_reports_missing_plugin() {
    ...
    assert_eq!(
        err.to_string(),
        "plugin `missing` was not found in marketplace `vac-curated`"
    );
}
...
fn list_marketplaces_resolves_plugin_interface_paths_to_absolute() {
  ...
  "interface": {
    ...
    assert_eq!(
        ...
        Some(vec![Product::VAC, Product::Chatgpt, Product::Atlas])
    );
    assert_eq!(
...
fn find_marketplace_plugin_skips_invalid_local_paths() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `local-plugin` was not found in marketplace `vac-curated`"
    );
}
...
fn find_installable_marketplace_plugin_rejects_disallowed_product() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `chatgpt-plugin` is not available for install in marketplace `vac-curated`"
    );
}
...
fn find_marketplace_plugin_allows_missing_products_field() {
  ...
  "plugins": [
    ...
    assert_eq!(resolved.plugin_id.as_key(), "default-plugin@vac-curated");
}
...
fn find_installable_marketplace_plugin_rejects_explicit_empty_products() {
  ...
  "plugins": [
    ...
    assert_eq!(
        err.to_string(),
        "plugin `disabled-plugin` is not available for install in marketplace `vac-curated`"
    );
}
