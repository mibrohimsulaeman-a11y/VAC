...
impl ToolCallRuntime {
    ...
    pub(crate) fn find_spec(&self, tool_name: &vac_tools::ToolName) -> Option<ToolSpec> {
    ...
    pub(crate) fn handle_tool_call(
    ...
    ) -> impl std::future::Future<Output = Result<ResponseInputItem, VACErr>> {
        ...
        async move {
            match future.await {
                ...
                Err(FunctionCallError::Fatal(message)) => Err(VACErr::Fatal(message)),
        ...
        match call.payload {
            ...
            ToolPayload::Custom { .. } => ResponseInputItem::CustomToolCallOutput {
                ...
                output: vac_protocol::models::FunctionCallOutputPayload {
                    body: vac_protocol::models::FunctionCallOutputBody::Text(message),
                    success: Some(false),
                },
            },
