...
fn handler_looks_up_namespaced_aliases_explicitly() {
    ...
    let namespace = "mcp__vac_apps__gmail";
    let tool_name = "gmail_get_recent_emails";
    let plain_name = vac_tools::ToolName::plain(tool_name);
    let namespaced_name = vac_tools::ToolName::namespaced(namespace, tool_name);
    ...
    let missing_namespaced = registry.handler(&vac_tools::ToolName::namespaced(
