...
use vac_tools::ToolHandlerKind;
use vac_tools::ToolName;
use vac_tools::ToolNamespace;
use vac_tools::ToolRegistryPlanDeferredTool;
use vac_tools::ToolRegistryPlanMcpTool;
use vac_tools::ToolRegistryPlanParams;
use vac_tools::ToolUserShellType;
use vac_tools::ToolsConfig;
use vac_tools::WaitAgentTimeoutOptions;
use vac_tools::augment_tool_spec_for_code_mode;
use vac_tools::build_tool_registry_plan;
...
pub(crate) fn build_specs_with_discoverable_tools(
    ...
    for unavailable_tool in unavailable_called_tools {
        ...
        if existing_spec_names.insert(tool_name.clone()) {
            let spec = vac_tools::ToolSpec::Function(ResponsesApiTool {
