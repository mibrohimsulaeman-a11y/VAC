...
impl CodeModeExecuteHandler {
    async fn execute(
        ...
        let args =
            vac_code_mode::parse_exec_source(&code).map_err(FunctionCallError::RespondToModel)?;
        ...
        let response = exec
            ...
            .services
            .code_mode_service
            .execute(vac_code_mode::ExecuteRequest {
        ...
        if !matches!(response, vac_code_mode::RuntimeResponse::Yielded { .. }) {
