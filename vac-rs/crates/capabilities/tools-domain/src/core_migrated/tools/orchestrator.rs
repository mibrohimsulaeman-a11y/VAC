...
use vac_otel::ToolDecisionSource;
...
impl ToolOrchestrator {
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let attempt_with_network_approval = SandboxAttempt {
            ...
            vac_linux_sandbox_exe: attempt.vac_linux_sandbox_exe,
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let initial_attempt = SandboxAttempt {
            ...
            vac_linux_sandbox_exe: turn_ctx.vac_linux_sandbox_exe.as_ref(),
            use_legacy_landlock,
        ...
        match first_result {
            ...
            Err(ToolError::VAC(VACErr::Sandbox(SandboxErr::Denied {
                output,
    ...
    async fn request_approval<Rq, Out, T>(
        ...
        otel: &vac_otel::SessionTelemetry,
