...
//!
//! `vac-rollout-trace` owns the event schema and writer behavior. This module
...
use vac_rollout_trace::ToolDispatchInvocation;
use vac_rollout_trace::ToolDispatchPayload;
use vac_rollout_trace::ToolDispatchRequester;
use vac_rollout_trace::ToolDispatchResult;
use vac_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        vac_turn_id: invocation.turn.sub_id.clone(),
