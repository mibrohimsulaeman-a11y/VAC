...
use tracing::warn;
use vac_hooks::HookEvent;
use vac_hooks::HookEventAfterToolUse;
use vac_hooks::HookPayload;
use vac_hooks::HookResult;
use vac_hooks::HookToolInput;
use vac_hooks::HookToolInputLocalShell;
use vac_hooks::HookToolKind;
...
use vac_utils_readiness::Readiness;
...
impl ToolRegistry {
    ...
    // VAC-DEBT(owner=vac-o5o6-zero-residual,target=post-cargo-hardening)(jif) for dynamic tools.
