...
use vac_sandboxing::SandboxTransformError;
...
pub(crate) enum ExecApprovalRequirement {
    ...
    Skip {
        ...
        /// Only applies if the command fails to run in sandbox and vac prompts the user to run outside the sandbox.
...
pub(crate) struct SandboxAttempt<'a> {
    ...
    pub permissions: &'a vac_protocol::models::PermissionProfile,
    pub enforce_managed_network: bool,
    pub(crate) manager: &'a SandboxManager,
    pub(crate) sandbox_cwd: &'a AbsolutePathBuf,
    pub vac_linux_sandbox_exe: Option<&'a std::path::PathBuf>,
    ...
    pub fn env_for(
        ...
        self.manager
            .transform(SandboxTransformRequest {
                ...
                vac_linux_sandbox_exe: self.vac_linux_sandbox_exe.map(std::path::PathBuf::as_path),
            ...
            .map(|request| {
                let windows_sandbox_policy_cwd =
                    vac_utils_absolute_path::AbsolutePathBuf::try_from(
