...
use vac_network_proxy::NetworkPolicyRequest;
use vac_network_proxy::NetworkProtocol;
...
impl NetworkApprovalService {
    ...
    async fn resolve_single_active_call(&self) -> Option<Arc<ActiveNetworkApprovalCall>> {
        ...
        // VAC-DEBT(owner=vac-o5o6-zero-residual,target=post-cargo-hardening): Carry blocked-request attribution so concurrent active calls can be handled safely.
