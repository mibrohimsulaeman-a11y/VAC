...
use vac_tools::TOOL_SEARCH_DEFAULT_LIMIT;
use vac_tools::TOOL_SEARCH_TOOL_NAME;
use vac_tools::coalesce_loadable_tool_specs;
...
mod tests {
    ...
    use vac_tools::ResponsesApiNamespace;
    ...
    fn mixed_search_results_coalesce_mcp_namespaces() {
        ...
        assert_eq!(
            ...
            vec![
                LoadableToolSpec::Namespace(ResponsesApiNamespace {
                    ...
                    tools: vec![
                        ResponsesApiNamespaceTool::Function(ResponsesApiTool {
                            ...
                            parameters: vac_tools::JsonSchema::object(
                                Default::default(),
                                /*required*/ None,
                                Some(false.into()),
                            ),
                ...
                LoadableToolSpec::Namespace(ResponsesApiNamespace {
                    name: "vac_app".to_string(),
                    description: "Tools in the vac_app namespace.".to_string(),
                    tools: vec![ResponsesApiNamespaceTool::Function(ResponsesApiTool {
                        ...
                        parameters: vac_tools::JsonSchema::object(
                            std::collections::BTreeMap::from([(
                                "mode".to_string(),
                                vac_tools::JsonSchema::string(/*description*/ None),
                            )]),
