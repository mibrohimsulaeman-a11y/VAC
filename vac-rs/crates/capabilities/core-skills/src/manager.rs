...
impl SkillsManager {
    pub fn new(vac_home: AbsolutePathBuf, bundled_skills_enabled: bool) -> Self {
        Self::new_with_restriction_product(vac_home, bundled_skills_enabled, Some(Product::VAC))
    }
    ...
    pub fn new_with_restriction_product(
        ...
        if !bundled_skills_enabled {
            ...
            uninstall_system_skills(&manager.vac_home);
        } else if let Err(err) = install_system_skills(&manager.vac_home) {
...
pub fn bundled_skills_enabled_from_stack(
    config_layer_stack: &vac_config::ConfigLayerStack,
) -> bool {
