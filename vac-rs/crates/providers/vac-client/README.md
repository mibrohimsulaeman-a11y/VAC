...
Generic transport layer that wraps HTTP requests, retries, and streaming primitives without any VAC/Vastar awareness.
...
- Consumed by higher-level crates like `vac-api`; it stays neutral on endpoints, headers, or API-specific error shapes.
