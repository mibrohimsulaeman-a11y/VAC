...
/// Bearer-token auth provider for Vastar-compatible model-provider requests.
...
mod tests {
    ...
    fn bearer_auth_provider_reports_when_auth_header_will_attach() {
        ...
        assert_eq!(
            vac_api::auth_header_telemetry(&auth),
            vac_api::AuthHeaderTelemetry {
                attached: true,
