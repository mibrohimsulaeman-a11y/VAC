...
pub use vac_client::BuildCustomCaTransportError as BuildLoginHttpClientError;
pub use vac_config::types::AuthCredentialsStoreMode;
...
pub use auth::VAC_AGENT_IDENTITY_ENV_VAR;
pub use auth::VAC_API_KEY_ENV_VAR;
pub use auth::VACAuth;
pub use auth::VASTAR_API_KEY_ENV_VAR;
...
pub use auth::read_vac_agent_identity_from_env;
pub use auth::read_vastar_api_key_from_env;
