...
impl IdTokenInfo {
    ...
    pub fn get_provider_credential_plan_type_raw(&self) -> Option<String> {
        self.get_chatgpt_plan_type_raw()
    }

    pub fn provider_credential_account_id(&self) -> Option<&str> {
...
struct IdClaims {
    #[serde(default)]
    email: Option<String>,
    #[serde(rename = "https://api.vastar.com/profile", default)]
    profile: Option<ProfileClaims>,
    #[serde(rename = "https://api.vastar.com/auth", default)]
...
#[derive(Deserialize)]
struct AuthClaims {
    #[serde(default, alias = "provider_credential_plan_type")]
    chatgpt_plan_type: Option<PlanType>,
    #[serde(default)]
    chatgpt_user_id: Option<String>,
    #[serde(default)]
    user_id: Option<String>,
    #[serde(default, alias = "provider_credential_account_id")]
...
pub fn parse_provider_credential_jwt_claims(jwt: &str) -> Result<IdTokenInfo, IdTokenInfoError> {
