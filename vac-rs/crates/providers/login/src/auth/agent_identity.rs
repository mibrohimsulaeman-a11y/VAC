...
use vac_agent_identity::register_agent_task;
...
const PROD_AGENT_IDENTITY_AUTHAPI_BASE_URL: &str = "https://auth.vastar.com/api/accounts";
const VAC_AGENT_IDENTITY_AUTHAPI_BASE_URL_ENV_VAR: &str = "VAC_AGENT_IDENTITY_AUTHAPI_BASE_URL";
...
fn agent_identity_authapi_base_url() -> String {
    env::var(VAC_AGENT_IDENTITY_AUTHAPI_BASE_URL_ENV_VAR)
        .ok()
...
mod tests {
    ...
    fn agent_identity_authapi_base_url_prefers_env_value() {
        let _guard = EnvVarGuard::set(
            VAC_AGENT_IDENTITY_AUTHAPI_BASE_URL_ENV_VAR,
    ...
    fn agent_identity_authapi_base_url_uses_prod_authapi_by_default() {
        let _guard = EnvVarGuard::remove(VAC_AGENT_IDENTITY_AUTHAPI_BASE_URL_ENV_VAR);
        assert_eq!(
            agent_identity_authapi_base_url(),
    ...
    impl EnvVarGuard {
        fn set(key: &'static str, value: &str) -> Self {
            ...
            // SAFETY: module boundary: this function validates or owns the raw pointer/platform handle before the unsafe operation; the multi-line unsafe block below uses inputs that remain live until the block returns.
            unsafe {
