//! Example: OpenTelemetry tracing with VAC Provider Core
//!
//! This example shows how to set up OpenTelemetry tracing with VAC Provider Core.
...
//! ```toml
//! [dependencies]
//! vac-provider-core = { version = "0.3", features = ["tracing"] }
//! tracing = "0.1"
...
fn main() {
    ...
    println!("=============================\n");
    println!("This example demonstrates the tracing pattern for VAC Provider Core.\n");
    println!("Quick Start:");
...
fn print_example_code() {
    let code = r#"
// ============================================================================
// Complete Example: VAC Provider Core with OpenTelemetry + Jaeger
// ============================================================================

use vac_provider_core::{GenerateRequest, Inference, Message, Role};
...
fn init_tracing() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tracing_subscriber::registry()
        ...
        .with(tracing_subscriber::EnvFilter::from_default_env()
            .add_directive("vac-provider-core=debug".parse()?))
        .init();
...
use vac_provider_core::StreamEvent;
