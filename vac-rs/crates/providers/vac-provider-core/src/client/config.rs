...
use crate::providers::{
    ...
    openrouter::OpenRouterConfig, vac::VacProviderConfig,
};
...
///
/// ```rust,no_run
/// use vac_provider_core::{Inference, InferenceConfig};
///
...
pub struct InferenceConfig {
    ...
    pub(crate) vac_config: Option<VacProviderConfig>,
...
impl InferenceConfig {
    ...
    ///
    /// ```rust,no_run
    /// # use vac_provider_core::InferenceConfig;
    ...
    ///
    /// ```rust,no_run
    /// # use vac_provider_core::{InferenceConfig, providers::openai::OpenAIConfig};
    ...
    ///
    /// ```rust,no_run
    /// # use vac_provider_core::{InferenceConfig, providers::anthropic::AnthropicConfig};
    ...
    ///
    /// ```rust,no_run
    /// # use vac_provider_core::{InferenceConfig, providers::gemini::GeminiConfig};
    ...
    /// Configure VAC provider with API key and optional base URL
    ///
    /// VAC provides unified access to multiple LLM providers through
    ...
    /// # use vac_provider_core::InferenceConfig;
    /// let config = InferenceConfig::new()
    ///     .vac("your-api-key", None);
    ///
    /// // With custom base URL
    /// let config = InferenceConfig::new()
    ///     .vac("your-api-key", Some("https://api.example.invalid/custom".to_string()));
    /// ```
    pub fn vac(mut self, api_key: impl Into<String>, base_url: Option<String>) -> Self {
        let mut config = VacProviderConfig::new(api_key);
        if let Some(url) = base_url {
            config = config.with_base_url(url);
        }
        self.vac_config = Some(config);
        self
    }

    /// Configure VAC provider with full VacProviderConfig
    ///
    /// # Example
    ///
    /// ```rust,no_run
    /// # use vac_provider_core::{InferenceConfig, providers::vac::VacProviderConfig};
    /// let vac_config = VacProviderConfig::new("your-api-key")
    ///     .with_base_url("https://api.example.invalid/custom");
    ///
    /// let config = InferenceConfig::new()
    ///     .vac_config(vac_config);
    /// ```
    pub fn vac_config(mut self, config: VacProviderConfig) -> Self {
        self.vac_config = Some(config);
        self
    }
    ...
    ///
    /// ```rust,no_run
    /// # use vac_provider_core::{InferenceConfig, providers::openrouter::OpenRouterConfig};
    ...
    ///
    /// ```rust,no_run
    /// # use vac_provider_core::{InferenceConfig, providers::bedrock::BedrockConfig};
