//! VAC streaming implementation

use super::provider::parse_vac_error;
use super::types::VACUsage;
...
pub struct VACChunk {
    pub id: String,
    pub choices: Vec<VACChunkChoice>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub usage: Option<VACUsage>,
}

/// VAC chunk choice
#[derive(Debug, Deserialize)]
pub struct VACChunkChoice {
    pub delta: VACDelta,
...
pub struct VACDelta {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub tool_calls: Option<Vec<VACToolCallDelta>>,
}

/// VAC tool call delta
#[derive(Debug, Deserialize)]
pub struct VACToolCallDelta {
    pub index: u32,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub function: Option<VACFunctionDelta>,
}

/// VAC function delta
#[derive(Debug, Deserialize)]
pub struct VACFunctionDelta {
    #[serde(skip_serializing_if = "Option::is_none")]
...
/// Create a streaming response from VAC
        ...
        while let Some(event) = event_stream.next().await {
            match event {
                ...
                Err(reqwest_eventsource::Error::InvalidStatusCode(status, response)) => {
                    ...
                    let friendly_error = parse_vac_error(&error_body, status.as_u16());
