use crate::default_client::VACHttpClient;
use crate::default_client::VACRequestBuilder;
...
impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: VACHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<VACRequestBuilder, TransportError> {
