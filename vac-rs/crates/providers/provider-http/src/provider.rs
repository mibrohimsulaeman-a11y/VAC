...
///
/// This is converted into a `RetryPolicy` used by `vac-client` to drive
...
mod tests {
    ...
    fn detects_azure_responses_base_urls() {
        let positive_cases = [
            "https://foo.vastar.azure.com/vastar",
            "https://foo.vastar.azure.us/vastar/deployments/bar",
            "https://foo.cognitiveservices.azure.cn/vastar",
            "https://foo.aoai.azure.com/vastar",
            "https://foo.vastar.azure-api.net/vastar",
        ...
        let negative_cases = [
            ...
            "https://example.com/vastar",
            "https://myproxy.azurewebsites.net/vastar",
        ];
