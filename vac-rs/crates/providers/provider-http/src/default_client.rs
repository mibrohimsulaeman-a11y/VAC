...
impl VACHttpClient {
    ...
    pub fn get<U>(&self, url: U) -> VACRequestBuilder
    where
        U: IntoUrl,
    {
    ...
    pub fn post<U>(&self, url: U) -> VACRequestBuilder
    where
        U: IntoUrl,
    {
    ...
    pub fn request<U>(&self, method: Method, url: U) -> VACRequestBuilder
    where
        U: IntoUrl,
    {
        let url_str = url.as_str().to_string();
        VACRequestBuilder::new(self.inner.request(method.clone(), url), method, url_str)
    }
}

#[must_use = "requests are not sent unless `send` is awaited"]
#[derive(Debug)]
pub struct VACRequestBuilder {
    builder: reqwest::RequestBuilder,
    method: Method,
    url: String,
}

impl VACRequestBuilder {
