...
use crate::services::vac_operator::VacOperatorState;
use std::sync::Arc;
use tokio::sync::mpsc;
...
pub struct AppState {
    ...
    pub vac_console_state: VacOperatorConsoleState,
    ...
    pub vac_operator_state: VacOperatorState,
}
...
impl AppState {
    pub fn get_helper_commands() -> Vec<HelperCommand> {
        ...
        for (name, description, prompt_content) in
            vac_remote_service::commands::load_predefined_commands()
        {
        ...
        // Load custom commands from ~/.vac/commands/ and .vac/commands/
    ...
    pub fn new(options: AppStateOptions) -> Self {
        ...
        AppState {
            ...
            vac_console_state: VacOperatorConsoleState::default(),
            ...
            // Policy persistence modal initialization
            approval_settings_persistence_state: ApprovalSettingsPersistenceModal::default(),
            ...
            vac_operator_state: VacOperatorState::default(),
    ...
    /// Poll `.vac/session/plan.md` for changes and update cached metadata.
    ///
