...
pub fn get_all_shortcuts() -> Vec<Shortcut> {
    vec![
        ...
        Shortcut::new("/status", "Show VAC runtime status", "Commands"),
        Shortcut::new("/runtime", "Show runtime jobs", "Commands"),
        Shortcut::new("/capabilities", "Show capability readiness", "Commands"),
