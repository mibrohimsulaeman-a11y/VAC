...
// ============================================================================
// Theme Detection - delegates to vac_foundation::terminal_theme
// ============================================================================

// Re-export shared theme detection so existing imports continue to work
pub use vac_foundation::terminal_theme::{Theme, current_theme, init_theme, is_light_mode};
...
impl ThemeColors {
    ...
    /// Theme-aware foreground for text rendered on strong accent backgrounds.
    pub fn background() -> Color {
        Self::highlight_fg()
    }

    /// Theme-aware black alias used by VAC operator widgets on highlighted labels.
    pub fn black() -> Color {
        Self::highlight_fg()
    }
