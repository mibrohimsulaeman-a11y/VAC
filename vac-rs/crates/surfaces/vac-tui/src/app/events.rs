...
pub enum InputEvent {
    ...
    GetStatus(String),
    BillingInfoLoaded(vac_foundation::models::billing::BillingResponse),
    Error(String),
    ...
    ShowAskUserPopup(
        ToolCall,
        Vec<vac_foundation::models::integrations::openai::AskUserQuestion>,
    ),
    AskUserNextTab,
    AskUserPrevTab,
    AskUserNextOption,
...
pub enum OutputEvent {
    ...
    UserMessage(
        ...
        Vec<vac_foundation::models::integrations::openai::ContentPart>,
