...
use vac_remote_service::models::ListRuleBook;
...
pub enum CommandSource {
    ...
    /// User-defined command loaded from `~/.vac/commands/` or `.vac/commands/`.
...
///
/// When plan mode is requested and `.vac/session/plan.md` already exists,
...
pub struct SidePanelState {
    ...
    pub billing_info: Option<vac_foundation::models::billing::BillingResponse>,
}
...
pub struct VacOperatorConsoleState {
    pub route: VacConsoleRoute,
}
...
pub struct PlanModeState {
    ...
    pub is_active: bool,
    /// Cached plan metadata from `.vac/session/plan.md` front matter
    pub metadata: Option<crate::services::plan::PlanMetadata>,
...
pub struct AskUserState {
    ...
    pub questions: Vec<vac_foundation::models::integrations::openai::AskUserQuestion>,
    /// User's answers (question label -> answer)
    pub answers: HashMap<String, vac_foundation::models::integrations::openai::AskUserAnswer>,
