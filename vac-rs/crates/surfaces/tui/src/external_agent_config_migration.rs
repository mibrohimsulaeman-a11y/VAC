...
use crate::session_protocol::PluginsMigration;
...
mod tests {
    ...
    fn sample_plugin_details() -> crate::session_protocol::MigrationDetails {
        crate::session_protocol::MigrationDetails {
            plugins: vec![
                PluginsMigration {
    ...
    fn sample_items() -> Vec<ExternalAgentConfigMigrationItem> {
        ...
        vec![
            ExternalAgentConfigMigrationItem {
                ...
                description:
                    "Migrate /Users/alex/.claude/settings.json into /Users/alex/.vac/config.toml"
                        .to_string(),
                cwd: None,
                details: None,
            },
