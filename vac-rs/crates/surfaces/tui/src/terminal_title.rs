...
// "leave the old title alone" or "clear the title VAC last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title VAC manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before VAC started managing the title.
