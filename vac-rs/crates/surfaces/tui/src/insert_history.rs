...
//
// VAC uses the terminal scrollback itself for finalized chat history, so inserting a history
...
impl Command for SetScrollRegion {
    ...
    fn is_ansi_code_supported(&self) -> bool {
        // VAC-DEBT(owner=vac-o5o6-zero-residual,target=post-cargo-hardening)(nornagon): is this supported on Windows?
        true
    }
}
