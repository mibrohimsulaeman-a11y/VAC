// O5/O6 balanced ChatWidget impl group: source split_017_is_auto_model.rs
impl ChatWidget {
    fn is_auto_model(model: &str) -> bool {
        model.starts_with("vac-auto-")
    }
    ...
    pub(crate) fn open_all_models_popup(&mut self, presets: Vec<ModelPreset>) {
        ...
        let header = self.model_menu_header(
            ...
            "Access legacy models by running vac -m <model_name> or in your config.toml",
        );
    ...
    pub(crate) fn open_reasoning_popup(&mut self, preset: ModelPreset) {
        ...
        let warn_for_model = preset.model.starts_with("gpt-5.1-vac")
            || preset.model.starts_with("gpt-5.1-vac-max")
