    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            PasteImageError::ClipboardUnavailable(msg) => write!(
                f,
                "clipboard unavailable: {msg}. Try a local desktop terminal, WSL PowerShell clipboard support, or OSC52-capable terminal settings"
            ),
...
pub fn normalize_pasted_path(pasted: &str) -> Option<PathBuf> {
    ...
    // VAC-DEBT(owner=vac-o5o6-zero-residual,target=post-cargo-hardening): We'll improve the implementation/unit tests over time, as appropriate.
    // Possibly use typed-path: https://github.com/vastar/vac/pull/2567/commits/3cc92b78e0a1f94e857cf4674d3a9db918ed352e
    //
