...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) branched_from_id: Option<ThreadId>,
    pub(crate) branch_parent_title: Option<String>,
    pub(crate) thread_name: Option<String>,
    pub(crate) model: String,
    pub(crate) model_provider_id: String,
    pub(crate) service_tier: Option<vac_protocol::config_types::ServiceTier>,
    pub(crate) approval_policy: AskForApproval,
    pub(crate) approvals_reviewer: vac_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<vac_protocol::vastar_models::ReasoningEffort>,
