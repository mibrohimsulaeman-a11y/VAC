...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            StatusSurfacePreviewItem::AppName => "vac",
            ...
            StatusSurfacePreviewItem::VACVersion => "0.0.0",
            ...
            StatusSurfacePreviewItem::Model => "gpt-5.2-vac",
            StatusSurfacePreviewItem::ModelWithReasoning => "gpt-5.2-vac medium",
