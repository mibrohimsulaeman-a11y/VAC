...
impl TerminalTitleItem {
    pub(crate) fn description(self) -> &'static str {
        match self {
            TerminalTitleItem::AppName => "VAC app name",
            ...
            TerminalTitleItem::VACVersion => "VAC application version",
    ...
    pub(crate) fn preview_item(self) -> Option<StatusSurfacePreviewItem> {
        match self {
            ...
            TerminalTitleItem::VACVersion => Some(StatusSurfacePreviewItem::VACVersion),
