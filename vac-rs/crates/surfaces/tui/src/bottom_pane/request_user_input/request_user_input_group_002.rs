// O5/O6 balanced request-user-input group: source request_user_input_part_002.rs
impl BottomPaneView for RequestUserInputOverlay {
    ...
    fn handle_key_event(&mut self, key_event: KeyEvent) {
        ...
        if matches!(key_event.code, KeyCode::Esc) {
            ...
            // VAC-DEBT(owner=vac-o5o6-zero-residual,target=post-cargo-hardening): Emit interrupted request_user_input results (including committed answers)
