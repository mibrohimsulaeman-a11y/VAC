...
// the fallback bucket.
//
// These caps are deliberately conservative: VAC is rebuilding normal terminal scrollback, not an
...
use vac_config::types::DEFAULT_TERMINAL_RESIZE_REFLOW_FALLBACK_MAX_ROWS;
