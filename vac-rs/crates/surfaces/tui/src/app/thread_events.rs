...
mod tests {
    use super::*;
    use crate::session_protocol::AppServerHookEventName;
    use crate::session_protocol::AppServerHookExecutionMode;
    use crate::session_protocol::AppServerHookHandlerType;
    use crate::session_protocol::AppServerHookScope;
    use crate::session_protocol::AskForApproval;
    use crate::session_protocol::CommandExecutionRequestApprovalParams;
    use crate::session_protocol::HookCompletedNotification;
    use crate::session_protocol::HookOutputEntry as AppServerHookOutputEntry;
    use crate::session_protocol::HookOutputEntryKind as AppServerHookOutputEntryKind;
    use crate::session_protocol::HookRunStatus as AppServerHookRunStatus;
    use crate::session_protocol::HookRunSummary as AppServerHookRunSummary;
    use crate::session_protocol::HookStartedNotification;
    ...
    fn thread_event_store_rebase_preserves_resolved_request_state() {
        ...
        store.push_notification(ServerNotification::ServerRequestResolved(
            crate::session_protocol::ServerRequestResolvedNotification {
                request_id: AppServerRequestId::Integer(1),
                thread_id: thread_id.to_string(),
            },
        ));
