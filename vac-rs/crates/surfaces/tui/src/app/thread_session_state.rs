...
mod tests {
    ...
    async fn permission_settings_sync_updates_active_snapshot_without_rewriting_side_thread() {
        ...
        app.config.permissions.approval_policy =
            vac_config::Constrained::allow_any(AskForApproval::OnRequest);
    ...
    async fn thread_read_fallback_uses_active_permission_settings() {
        ...
        let read_thread = Thread {
            ...
            created_at: 1,
            updated_at: 2,
            status: crate::session_protocol::ThreadStatus::Idle,
            path: None,
            cwd: test_path_buf("/tmp/read").abs(),
            cli_version: "0.0.0".to_string(),
            source: crate::session_protocol::SessionSource::Unknown.into(),
            agent_nickname: None,
            agent_role: None,
            git_info: None,
