...
use crate::session_protocol::CommandExecutionRequestApprovalResponse;
use crate::session_protocol::FileChangeRequestApprovalResponse;
use crate::session_protocol::JSONRPCErrorError;
use crate::session_protocol::McpServerElicitationRequestResponse;
use crate::session_protocol::PermissionsRequestApprovalResponse;
use crate::session_protocol::RequestId as AppServerRequestId;
use crate::session_protocol::ServerRequest;

impl App {
    pub(super) async fn reject_app_server_request<S>(
        &self,
        app_server_client: &mut S,
...
mod tests {
    ...
    use crate::session_protocol::AdditionalFileSystemPermissions;
    ...
    use crate::session_protocol::McpElicitationObjectType;
    use crate::session_protocol::McpElicitationSchema;
    ...
    use crate::session_protocol::PermissionGrantScope;
    use crate::session_protocol::PermissionsRequestApprovalParams;
    use crate::session_protocol::PermissionsRequestApprovalResponse;
    use crate::session_protocol::RequestId as AppServerRequestId;
    use crate::session_protocol::ServerRequest;
    use crate::session_protocol::ToolRequestUserInputAnswer;
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        let permissions = pending
            .take_resolution(&Op::RequestPermissionsResponse {
                id: "perm-1".to_string(),
                response: vac_protocol::request_permissions::RequestPermissionsResponse {
                    ...
                    scope: vac_protocol::request_permissions::PermissionGrantScope::Session,
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: crate::session_protocol::GrantedPermissionProfile {
                ...
                scope: PermissionGrantScope::Session.into(),
    ...
    fn rejects_dynamic_tool_calls_as_unsupported() {
        ...
        let unsupported = pending
            .note_server_request(&ServerRequest::DynamicToolCall {
                ...
                params: crate::session_protocol::DynamicToolCallParams {
                    thread_id: "thread-1".to_string(),
                    turn_id: "turn-1".to_string(),
    ...
    fn does_not_mark_chatgpt_auth_refresh_as_unsupported() {
        ...
        assert_eq!(
            pending.note_server_request(&ServerRequest::ChatgptAuthTokensRefresh {
                ...
                params: crate::session_protocol::ChatgptAuthTokensRefreshParams {
                    reason: crate::session_protocol::ChatgptAuthTokensRefreshReason::Unauthorized,
