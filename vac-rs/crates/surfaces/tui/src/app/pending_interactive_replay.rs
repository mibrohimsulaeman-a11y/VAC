...
mod tests {
    ...
    use crate::session_protocol::ServerNotification;
    use crate::session_protocol::ServerRequest;
    use crate::session_protocol::ServerRequestResolvedNotification;
    use crate::session_protocol::ThreadClosedNotification;
    ...
    fn thread_event_snapshot_drops_resolved_patch_approval_after_outbound_approval() {
        ...
        store.note_outbound_op(&Op::PatchApproval {
            id: "call-1".to_string(),
            decision: crate::session_protocol::FileChangeApprovalDecision::Accept,
        });
