...
mod tests {
    ...
    fn make_skills() -> Vec<Skill> {
        vec![Skill {
            ...
            uri: "vac://test/skill.md".to_string(),
            description: "Test skill".to_string(),
            source: vac_remote_service::models::SkillSource::Remote {
                provider: vac_remote_service::models::RemoteProvider::Rulebook {
                    visibility: vac_remote_service::models::RuleBookVisibility::Public,
                },
            },
            content: None,
