...
//! Cache location: `~/.vac/cache/models.json`
//! Cache TTL: 1 hour
...
use tokio::fs;
use vac_provider_core::{ProviderInfo, fetch_models_dev};
...
const CACHE_PATH: &str = ".vac/cache/models.json";
...
mod tests {
    ...
    fn test_cache_path_contains_expected_path() {
        ...
        assert!(path.to_string_lossy().contains(".vac/cache/models.json"));
    }
