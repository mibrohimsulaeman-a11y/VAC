...
use std::fmt;
use vac_foundation::models::{integrations::openai::ChatMessage, llm::LLMTokenUsage};
use vac_remote_service::storage::{SessionStats, ToolUsageStats};
...
impl OutputRenderer {
            ...
            OutputFormat::Json => {
                if self.verbose {
                    ...
                    let final_message = messages.iter().rev().find(|m| {
                        m.role == vac_foundation::models::integrations::openai::Role::Assistant
                    });
    ...
    fn extract_content_string(
        &self,
        content: &vac_foundation::models::integrations::openai::MessageContent,
    ) -> String {
        match content {
            vac_foundation::models::integrations::openai::MessageContent::String(s) => s.clone(),
            vac_foundation::models::integrations::openai::MessageContent::Array(parts) => parts
                .iter()
