...
//! # Commands
//!
//! - `vac auth login` - Authenticate with a provider
//! - `vac auth logout` - Remove stored credentials
//! - `vac auth list` - List configured credentials
...
pub enum AuthCommands {
    ...
    Login {
        /// Provider to authenticate with (e.g., "anthropic", "openai", "gemini", "vac", "amazon-bedrock")
        #[arg(long, default_value = "vac")]
        provider: String,
