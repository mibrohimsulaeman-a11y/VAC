//! Message filtering for `vac sessions show`.
//!
//! Applies `--role`, `--limit`, and `--offset` flags to a checkpoint's messages.

use vac_foundation::models::integrations::openai::{ChatMessage, Role};
...
mod tests {
    use super::*;
    use vac_foundation::models::integrations::openai::MessageContent;
