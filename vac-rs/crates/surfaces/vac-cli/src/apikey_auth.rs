...
const CLIENT_ID: &str = "vac-cli";
const GENERATE_API_KEY_URL: &str = "https://vastar.ai/generate-api-key";
...
async fn listen_for_callback(url: &str) -> String {
    ...
    while start_time.elapsed() < std::time::Duration::from_secs(120) {
        let client = match vac_foundation::tls_client::create_tls_client(
...
fn success_message() {
    ...
    println!("\x1b[1;36m└──────────────────────────────────────────────────────────────┘\x1b[0m");
    println!();
    println!("You're all set! Opening VAC...");
    println!();
}
...
pub async fn prompt_for_api_key(config: &mut AppConfig) {
    ...
    println!("\x1b[1;36m┌──────────────────────────────────────────────────────────────┐\x1b[0m");
    println!(
        "\x1b[1;36m│\x1b[0m \x1b[1;33m                  VAC API Key Required                  \x1b[0m \x1b[1;36m│\x1b[0m"
    );
    println!("\x1b[1;36m└──────────────────────────────────────────────────────────────┘\x1b[0m");
    println!();
