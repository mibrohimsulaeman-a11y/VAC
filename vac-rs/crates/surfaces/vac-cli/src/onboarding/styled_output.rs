//! Styled output utilities for inline terminal output matching VAC TUI style guide

use crate::utils::cli_colors::CliColors;

/// ANSI color codes matching VAC TUI style
...
pub fn render_telemetry_disclaimer() {
    ...
    print!(
        "{}│{}  we collect anonymous telemetry to improve vac.      {}│{}\r\n",
        border, r, border, r
    );
    print!(
