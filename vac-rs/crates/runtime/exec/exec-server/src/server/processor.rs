    ...
    while let Some(event) = incoming_rx.recv().await {
        ...
        match event {
            JsonRpcConnectionEvent::MalformedMessage { reason } => {
                ...
                if outgoing_tx
                    .send(RpcServerOutboundMessage::Error {
                        request_id: vac_runtime_protocol::RequestId::Integer(-1),
            ...
            JsonRpcConnectionEvent::Message(message) => match message {
                vac_runtime_protocol::JSONRPCMessage::Request(request) => {
                ...
                vac_runtime_protocol::JSONRPCMessage::Notification(notification) => {
                ...
                vac_runtime_protocol::JSONRPCMessage::Response(response) => {
                    warn!(
                ...
                vac_runtime_protocol::JSONRPCMessage::Error(error) => {
                    warn!(
