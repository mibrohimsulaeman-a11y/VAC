...
use vac_exec_server::CopyOptions;
...
use vac_exec_server::LocalFileSystem;
use vac_exec_server::ReadDirectoryEntry;
...
use common::exec_server::TestVACHelperPaths;
use common::exec_server::exec_server;
#[cfg(target_os = "linux")]
use common::exec_server::exec_server_with_env;
use common::exec_server::test_vac_helper_paths;

struct FileSystemContext {
    file_system: Arc<dyn ExecutorFileSystem>,
    _helper_paths: Option<TestVACHelperPaths>,
...
async fn create_file_system_context(use_remote: bool) -> Result<FileSystemContext> {
    if use_remote {
        ...
        let helper_paths = test_vac_helper_paths()?;
        let runtime_paths = ExecServerRuntimePaths::new(
            helper_paths.vac_exe.clone(),
            helper_paths.vac_linux_sandbox_exe.clone(),
        )?;
        Ok(FileSystemContext {
