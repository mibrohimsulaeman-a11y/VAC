...
//! `EscalateRequest` over the inherited `VAC_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `VAC_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use vac_protocol::approvals::EscalationPermissions;
pub use vac_protocol::approvals::ResolvedPermissionProfile;
