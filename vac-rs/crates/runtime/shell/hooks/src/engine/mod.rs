...
pub(crate) struct ConfiguredHandler {
    pub event_name: vac_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            vac_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            vac_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            vac_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            vac_protocol::protocol::HookEventName::SessionStart => "session-start",
            vac_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
