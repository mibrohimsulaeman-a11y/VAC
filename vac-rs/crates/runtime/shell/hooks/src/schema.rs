...
pub(crate) struct PreToolUseCommandInput {
    ...
    /// VAC extension: expose the active turn id to internal turn-scoped hooks.
    pub turn_id: String,
...
mod tests {
    ...
    #[test]
    fn turn_scoped_hook_inputs_include_vac_turn_id_extension() {
        // VAC intentionally diverges from Claude's public hook docs here so
