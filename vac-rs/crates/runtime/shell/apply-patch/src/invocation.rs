...
// VAC-DEBT(owner=vac-o5o6-zero-residual,target=post-cargo-hardening): make private once we remove tests in lib.rs
...
pub async fn maybe_parse_apply_patch_verified(
    ...
    sandbox: Option<&vac_exec_server::FileSystemSandboxContext>,
