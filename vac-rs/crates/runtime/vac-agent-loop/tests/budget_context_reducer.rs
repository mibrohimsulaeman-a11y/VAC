use serde_json::json;
use vac_agent_loop::{BudgetAwareContextReducer, ContextReducer};
use vac_provider_core::{ContentPart, Message, MessageContent, Model, ModelLimit, Role, Tool};
    ...
    let messages = vec![
        Message {
            ...
            content: MessageContent::Parts(vec![
                ContentPart::tool_call("tc_1", "vac__view", json!({"path":"README.md"})),
                ContentPart::tool_call("tc_2", "vac__view", json!({"path":"Cargo.toml"})),
            ]),
            name: None,
            provider_options: None,
        },
