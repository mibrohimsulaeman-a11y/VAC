...
//! vac home directory creation and git safe.directory injection so sandboxed
...
/// Ensure the sandbox vac home directory exists.
pub fn ensure_vac_home_exists(p: &Path) -> Result<()> {
