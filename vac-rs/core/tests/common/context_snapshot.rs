...
use vac_protocol::protocol::PLUGINS_INSTRUCTIONS_OPEN_TAG;
use vac_protocol::protocol::SKILLS_INSTRUCTIONS_OPEN_TAG;
...
mod tests {
    ...
    fn redacted_text_mode_normalizes_system_skill_temp_paths() {
        let items = vec![json!({
            ...
            "content": [{
                "type": "input_text",
                "text": "## Skills\n- vastar-docs: helper (file: /private/var/folders/yk/p4jp9nzs79s5q84csslkgqtm0000gn/T/.tmpAnGVww/skills/.system/vastar-docs/SKILL.md)"
            }]
        })];
        ...
        assert_eq!(
            rendered,
            "00:message/developer:## Skills\\n- vastar-docs: helper (file: <SYSTEM_SKILLS_ROOT>/vastar-docs/SKILL.md)"
        );
    }
}
