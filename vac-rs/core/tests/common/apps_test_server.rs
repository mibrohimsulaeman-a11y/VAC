...
const SERVER_NAME: &str = "vac-apps-test";
...
async fn mount_streamable_http_json_rpc(
    ...
    Mock::given(method("POST"))
        .and(path_regex("^/api/vac/apps/?$"))
        .respond_with(VACAppsJsonRpcResponder {
            connector_name,
...
struct VACAppsJsonRpcResponder {
    connector_name: String,
    connector_description: String,
    searchable: bool,
}

impl Respond for VACAppsJsonRpcResponder {
        ...
        match method {
                        ...
                        "tools": [
                            {
                                ...
                                "_meta": {
                                    ...
                                    "vastar/outputTemplate": CALENDAR_CREATE_EVENT_MCP_APP_RESOURCE_URI,
                                    "_vac_apps": {
            ...
            "tools/call" => {
                ...
                let file_id = body
                    ...
                    .and_then(Value::as_str)
                    .unwrap_or_default();
                let vac_apps_meta = body.pointer("/params/_meta/_vac_apps").cloned();
