...
use crate::test_vac::ApplyPatchModelOutput;
...
pub fn ev_model_verification_metadata(id: &str, verifications: Vec<&str>) -> Value {
    serde_json::json!({
        ...
        "response_id": id,
        "metadata": {
            "vastar_verification_recommendation": verifications,
        }
    })
}
    ...
    impl Respond for UserHistorySummaryResponder {
        fn respond(&self, request: &wiremock::Request) -> ResponseTemplate {
            ...
            let mut output = body_json
                ...
                .unwrap_or_default()
                .into_iter()
                // VAC-DEBT(owner=vac-o5o6-zero-residual,target=post-cargo-hardening)(ccunningham): Update this mock to match future compaction model behavior:
